...
- It rotates through self-running demos such as Snake, Conway's Life, a fire effect, Langton's ants, a flood-fill maze animation, falling Matrix code, a 3D Starfield, a rolling and pulsing 3D wireframe Cube, an Orbit particle sculpture, a zooming vector Tunnel, a Demoscene Plasma effect, and a Mystify screensaver effect.
