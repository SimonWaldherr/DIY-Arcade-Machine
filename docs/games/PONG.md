...
| An arcade version can use an opponent that follows the ball instead of full prediction. | The right paddle uses a deliberately imperfect chase heuristic that gets faster as the score rises. |
